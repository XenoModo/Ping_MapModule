...
@IBDesignable open class FrstnmeLstnme: TextFieldUI{
    ...
    @IBInspectable dynamic open var placeholderFrontScale: CGFloat = 0.65 {
        didSet{
            updatePlaceholder()
        }
    }
    ...
    private func placeholderFontFromFont(_ font: UIFont) -> UIFont! {
        let smallerFont = UIFont(name: font.fontName, size: font.pointSize * placeholderFrontScale)
        return smallerFont
    }
